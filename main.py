...
class App(TkinterDnD.Tk):
    def __init__(self):
        ...
        self.copy_button = tk.Button(self, text="Copy Questions", font=("Arial", 18), command=lambda:self.copy_to_clipboard(FinalText, "questions"))
        self.copy_answers_button = tk.Button(self, text="Copy Answers" ,font=("Arial", 18), command=lambda:self.copy_to_clipboard(AnswersText, "answers"))
    ...
    def drop(self, event):
        ...
        self.copy_button.pack(side="left", pady=5, expand=True)
        self.copy_answers_button.pack(side="right", pady=5, expand=True)
